...
echo "=========================================="
echo "GraalVM Native Image Build for CanvasImageGrid"
echo "=========================================="
echo ""
...
echo ""
echo "Step 2: Creating native image..."
echo "This may take 5-10 minutes..."
echo ""

# Create native image with comprehensive JavaFX support
native-image \
    --no-fallback \
    --verbose \
...
if [ $? -eq 0 ]; then
    ...
    echo "=========================================="
    echo ""
    echo "Location: target/CanvasImageGrid"
    echo "Size: $(du -h target/CanvasImageGrid | cut -f1)"
    echo ""
    echo "To run:"
    echo "  ./target/CanvasImageGrid <image-directory>"
    echo ""
    echo "Example:"
    echo "  ./target/CanvasImageGrid ~/Pictures"
    echo ""
else
    echo ""
    echo "=========================================="
    ...
    echo "3. Check that you have enough memory (4GB+ recommended)"
    echo ""
    exit 1
fi
